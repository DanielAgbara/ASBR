...
% Solve pose IK
%% =========================
[theta_sol, theta_history, norm_w_b_hist, norm_v_b_hist] = numerical_inverse_kinematics_pose( ...
    M_ee, ...
    B_list, ...
    theta_a, ...
    T_sd, ...
...
% Save videos
%% =========================
% save_robot_motion_video(robot, theta_history, T_list, Jw_cell, Jv_cell, 'ik_robot_motion.mp4');
