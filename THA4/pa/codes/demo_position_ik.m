...
%% =========================
urdfPath = fullfile(fileparts(which('demo_position_ik')), '..', 'kuka_lbr_iiwa_support', 'urdf', 'lbr_iiwa_14_r820.urdf');
...
%% =========================
[theta_sol, theta_history, norm_err_hist] = constrained_linear_ls_pos( ...
    M_tool, ...
    S_list, ...
    theta_a, ...
    p_goal, ...
...
% save_robot_motion_video( ...
%     robot, theta_history, T_list, ...
%     'pos_robot_motion.mp4', wall_viz, p_goal, r);
